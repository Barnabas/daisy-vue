...
* Use src/components/Alert.vue as a component pattern and src/views/demos/AlertDemo.vue as a demo page pattern.
...
* Prioritize using record constants rather than if statements; for example, TYPE_CLASSES in src/components/Alert.vue.
